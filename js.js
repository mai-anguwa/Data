...
setInterval(
function data(){
  var amount = Math.floor(Math.random()*990);
  
var send = Math.random()*99999990;
 let sender = Math.floor(send)
var tim = new Date();
var time = tim.getMinutes();
var tie = time + ":" + tim.getSeconds();

document.getElementById('amount').innerHTML = amount.toLocaleString()+"GB";
document.getElementById('sender').innerHTML = "+" +sender;
document.getElementById('time').innerHTML =  tie;
if(amount>10000){
